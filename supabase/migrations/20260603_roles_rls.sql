...
DROP POLICY IF EXISTS "events editable by location editors" ON events;
CREATE POLICY "events editable by location editors" ON events FOR INSERT
  WITH CHECK (can_edit_location(location_slug));
DROP POLICY IF EXISTS "events updatable by location editors" ON events;
...
DROP POLICY IF EXISTS "events deletable by location editors" ON events;
...
DROP POLICY IF EXISTS "location_info editable by location editors" ON location_info;
...
DROP POLICY IF EXISTS "location_info updatable by location editors" ON location_info;
CREATE POLICY "location_info updatable by location editors" ON location_info FOR UPDATE
  ...
  WITH CHECK (EXISTS (SELECT 1 FROM locations l
                      WHERE l.id = location_info.location_id AND can_edit_location(l.slug)));
DROP POLICY IF EXISTS "location_info deletable by location editors" ON location_info;
...
DROP POLICY IF EXISTS "locations admin insert" ON locations;
CREATE POLICY "locations admin insert" ON locations FOR INSERT WITH CHECK (is_admin());
DROP POLICY IF EXISTS "locations admin update" ON locations;
CREATE POLICY "locations admin update" ON locations FOR UPDATE USING (is_admin());
DROP POLICY IF EXISTS "locations admin delete" ON locations;
...
DROP POLICY IF EXISTS "gospels admin insert" ON gospels;
CREATE POLICY "gospels admin insert" ON gospels FOR INSERT WITH CHECK (is_admin());
DROP POLICY IF EXISTS "gospels admin update" ON gospels;
CREATE POLICY "gospels admin update" ON gospels FOR UPDATE USING (is_admin());
DROP POLICY IF EXISTS "gospels admin delete" ON gospels;
...
DROP POLICY IF EXISTS "gospel_daily admin insert" ON gospel_daily;
CREATE POLICY "gospel_daily admin insert" ON gospel_daily FOR INSERT WITH CHECK (is_admin());
DROP POLICY IF EXISTS "gospel_daily admin update" ON gospel_daily;
CREATE POLICY "gospel_daily admin update" ON gospel_daily FOR UPDATE USING (is_admin());
DROP POLICY IF EXISTS "gospel_daily admin delete" ON gospel_daily;
...
DROP POLICY IF EXISTS "comment_sections admin insert" ON comment_sections;
CREATE POLICY "comment_sections admin insert" ON comment_sections FOR INSERT WITH CHECK (is_admin());
DROP POLICY IF EXISTS "comment_sections admin update" ON comment_sections;
CREATE POLICY "comment_sections admin update" ON comment_sections FOR UPDATE USING (is_admin());
DROP POLICY IF EXISTS "comment_sections admin delete" ON comment_sections;
...
DROP POLICY IF EXISTS "media admin insert" ON media;
CREATE POLICY "media admin insert" ON media FOR INSERT WITH CHECK (is_admin());
DROP POLICY IF EXISTS "media admin update" ON media;
CREATE POLICY "media admin update" ON media FOR UPDATE USING (is_admin());
DROP POLICY IF EXISTS "media admin delete" ON media;
...
DROP POLICY IF EXISTS "seeds admin insert" ON seeds;
CREATE POLICY "seeds admin insert" ON seeds FOR INSERT WITH CHECK (is_admin());
DROP POLICY IF EXISTS "seeds admin update" ON seeds;
CREATE POLICY "seeds admin update" ON seeds FOR UPDATE USING (is_admin());
DROP POLICY IF EXISTS "seeds admin delete" ON seeds;
